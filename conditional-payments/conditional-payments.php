...
if ( !defined( 'DSCPW_PLUGIN_PATH' ) ) {
    define( 'DSCPW_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );
}
...
if ( !defined( 'DSCPW_STORE_URL' ) ) {
    define( 'DSCPW_STORE_URL', 'https://www.thedotstore.com/' );
}
/**
